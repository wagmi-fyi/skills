...
5. **Platform escalation:** a service outage (5xx) or a suspended firm belongs to whoever runs the AMA copy the adapter calls. For a lost firm key, sign up again.
